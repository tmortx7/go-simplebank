DB_URL=postgres://root:root@localhost:5432/simple_bank?sslmode=disable
postgres:
...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/tmortx7/go-simplebank/db/sqlc Store
